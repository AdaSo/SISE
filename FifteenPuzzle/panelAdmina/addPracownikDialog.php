...
<html lang="pl">
  <head>
    ...
    <title>Zarządzanie pracownikami - dodawanie</title>
    ...
    <div class="container">
        ...
        <div  id="addData" tabindex="-1" role="dialog" aria-labelledby="addLabel">
            ...
            <div class="modal-content">
                ...
                <h4 class="modal-title" id="addLabel">Dodanie pracownika</h4>           
                <div>
                    <form> 
                        <div class="modal-body">                               
                            ...
                            <div class="form-group">
                                <label for="ph">Data zatrudnienia</label>
                                <input type="number" class="form-control" id="data" placeholder="Data zatrudnienia">
                            </div> 

                            <div class="form-group">
                                <label for="nm">Specjalizacja</label>
                                <textarea type="text" class="form-control" id="spec" placeholder="Specjalizacja"></textarea>
                            </div>                    
                        </div>
